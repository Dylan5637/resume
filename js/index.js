...
$('#sect3 ul li a').on('click', function(e){
    ...
    .append('<button class="prev"><i class="fas fa-angle-left"></i></button><button class="arrow next"><i class="fas fa-angle-right"></i></button>')
    $('.inlayer .close').css({
        border:'none',
        position:'absolute',
        top:'-25px', right:'-25px',
...
$('body').on('click', '.inlayer .close, .outlayer', function(){
    // p.498
    $('.outlayer').remove()
})
